          ...
          <div className="navbar-custom-menu">
            <ul className="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul className="menu">
                      ...
                      <li>
                        <a href="#">
                          <div className="pull-left">
                            <img src="admin_lte/dist/img/user2-160x160.jpg"
                      ...
                      <li>
                        <a href="#">
                          <div className="pull-left">
                            <img src="admin_lte/dist/img/user3-128x128.jpg"
                                 className="img-circle"
                                 alt="User Image"/>
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div className="pull-left">
                            <img src="admin_lte/dist/img/user4-128x128.jpg"
                                 className="img-circle"
                                 alt="User Image"/>
                          </div>
                          <h4>
              ...
              <li className="dropdown user user-menu">
                <a href="#" className="dropdown-toggle" data-toggle="dropdown">
                  <img src="admin_lte/dist/img/user2-160x160.jpg" className="user-image"
                       alt="User Image"/>
